...
template boost::optional<int> MAPNIK_DECL parameters::get(std::string const& key) const;
template boost::optional<int> MAPNIK_DECL parameters::get(std::string const& key, int const& default_opt_value) const;

template boost::optional<mapnik::boolean> MAPNIK_DECL parameters::get(std::string const& key) const;
template boost::optional<mapnik::boolean> MAPNIK_DECL parameters::get(std::string const& key, mapnik::boolean const& default_opt_value) const;
